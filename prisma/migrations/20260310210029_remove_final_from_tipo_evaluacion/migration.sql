...
CREATE TABLE "new_ASIGNACION_ACADEMICA" (
    ...
    "motivoBaja" TEXT,
    "fechaBaja" DATETIME,
    CONSTRAINT "ASIGNACION_ACADEMICA_idProfesor_fkey" FOREIGN KEY ("idProfesor") REFERENCES "PROFESOR" ("idProfesor") ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO "new_ASIGNACION_ACADEMICA" ("cargaHoraria", "estado", "fechaBaja", "idAsignacion", "idCiclo", "idCurso", "idMateria", "idProfesor", "motivoBaja") SELECT "cargaHoraria", "estado", "fechaBaja", "idAsignacion", "idCiclo", "idCurso", "idMateria", "idProfesor", "motivoBaja" FROM "ASIGNACION_ACADEMICA";
